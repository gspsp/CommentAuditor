...
class CommentAuditor_Plugin implements Typecho_Plugin_Interface
{
	...
	public static function fetch($url, $type = 'GET', $params = array())
	{
		...
		curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.72 Safari/537.36 Edg/89.0.774.45");
